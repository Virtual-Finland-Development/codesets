...
export function createCacheUpdaterLambdaFunction(bucketName: string, lambdaAtEdgeFunction: aws.lambda.Function) {
    ...
    const lambdaFunction = new aws.lambda.Function(
        getResourceName('CacheUpdaterFunction'),
        {
        ...
        { dependsOn: [lambdaAtEdgeFunction] }
    );
